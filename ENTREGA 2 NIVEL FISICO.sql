...
GRANT ROL_ADMIN_SISTEMA TO PLYTIX;

-- CREAMOS USUARIOS CON ROLES ROL_GESTOR_CUENTAS Y ROL_PLANIFICADOR_SERVICIOS

CREATE USER GESTOR_CUENTAS IDENTIFIED BY bd;
GRANT ROL_GESTOR_CUENTAS TO GESTOR_CUENTAS;

CREATE USER PLANIFICADOR_SERVICIOS IDENTIFIED BY bd;
GRANT ROL_PLANIFICADOR_SERVICIOS TO PLANIFICADOR_SERVICIOS;
